...
namespace XWA_Multiplayer_Connector.Classes.Networking.Payloads.Server
{
    class ServerMessageTypes
    {
        ...
        */
        ...
        public static void DetermineMethodandChannel(ServerMessageType messageType, out NetDeliveryMethod deliverymethod, out int? sequenceChannel)
        {
